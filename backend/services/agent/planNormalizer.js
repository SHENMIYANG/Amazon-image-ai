...
export function normalizeStrategyPlans({
  ...
  return requestedTasks.map((requestedTask, index) => {
    ...
    return {
      ...
      layoutTemplateId: requestedTask.layoutTemplateId || null,
      layoutTemplateName: requestedTask.layoutTemplateName || '',
      layoutTemplateUrl: requestedTask.layoutTemplateUrl || '',
